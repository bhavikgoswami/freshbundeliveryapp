...
import com.witnovus.freshbundeliveryapp.databinding.HelpAndSupportActivityBinding
...
import com.witnovus.freshbundeliveryapp.utils.Constants.Companion.SUPPORT_EMAIL
...
class HelpAndSupportActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.emailBtn.setOnClickListener {
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.lbl_support_nepzep))
