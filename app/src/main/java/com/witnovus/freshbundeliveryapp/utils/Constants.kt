...
class Constants {
    companion object {
        ...
        //API URLs
        const val BASE_URL = "https://app.nepzep.com/api/"
        const val SCREEN_WIDTH = "width"
        const val PREFIX_DOMAIN = "https://app.nepzep.com/"
        const val BASE_URL_IMAGE = "https://app.nepzep.com/"

/*
        const val TERMS_AND_CONDITION_URL = "http://nepzep.com/"
        const val PRIVACY_POLICY_URL = "http://nepzep.com/"
*/
        ...
        const val FAQ_URL = "http://nepzep.com/"
        const val TERMS_AND_CONDITION_URL = "https://nepzep.com/terms_condition.html"
        const val PRIVACY_POLICY_URL = "https://nepzep.com/privacy_policy.html"
        const val ABOUT_US_URL = "http://nepzep.com/"
        const val SUPPORT_EMAIL = "contact@nepzep.com"
        const val PHONE_NUMBER = "+919727555615"

        const val API_KEY = "AIzaSyBTGyfY65v2xMGw5dsqkEI0DsrRDF9OQ4U"
        const val PROJECT_ID = "nepzepapplication"
        const val APPLICATION_ID ="1:9683615562:android:b8ea99286334b65e9b4bb3"
