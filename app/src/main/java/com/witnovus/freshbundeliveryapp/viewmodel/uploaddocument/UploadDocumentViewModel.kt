package com.witnovus.freshbundeliveryapp.viewmodel.uploaddocument
...
import com.witnovus.freshbundeliveryapp.model.uploaddocument.addaddressdetail.AddAddressDetailResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.addadharcarddetail.AddAdharCardDetailResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.addbankdetail.addbank.AddBankDetailResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.addbankdetail.banklist.BankListResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.addbankdetail.banklist.Record
import com.witnovus.freshbundeliveryapp.model.uploaddocument.addlicensedetail.AddLicenseDetailResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.addpancarddetail.AddPanCardDetailResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.documentlistdetail.DocumentListResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.getaddressdetail.GetAddressDetailResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.getadharcarddetail.GetAdharCardDetailResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.getbankdetail.Bank
import com.witnovus.freshbundeliveryapp.model.uploaddocument.getbankdetail.GetBankDetailResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.getlincencedetail.GetLincenceDetaillResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.updateaddressdetail.UpdateAddressDetailResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.updateadharcard.UpdateAdharCardDetailResponse
import com.witnovus.freshbundeliveryapp.model.uploaddocument.updatelincencedetail.UpdatlLincenceDetailResponse
