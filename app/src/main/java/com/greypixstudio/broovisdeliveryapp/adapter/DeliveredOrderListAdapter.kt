...
class DeliveredOrderListAdapter (
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.row_delivered_order_list, parent, false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.totalQualityOrderTextView.text = deliveredOrderList[position].totalQty.toInt().toString()
        ...
        if (deliveredOrderList[position].deliveryStatus.equals(Constants.ORDER_DELIVERED)){
        ...
        if (deliveredOrderList[position].deliveryStatus.equals(Constants.ORDER_NOT_DELIVERED)){
