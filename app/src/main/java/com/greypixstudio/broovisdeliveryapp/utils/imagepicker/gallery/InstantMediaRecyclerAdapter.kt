...
import com.greypixstudio.broovisdeliveryapp.databinding.RecyclerItemMediaBinding
import com.greypixstudio.broovisdeliveryapp.utils.imagepicker.interfaces.MediaClickInterface
import com.greypixstudio.broovisdeliveryapp.utils.imagepicker.utils.GeneralUtils.convertDpToPixel

class InstantMediaRecyclerAdapter(
    val mMediaList: ArrayList<MediaModel>,
    val mInterface: MediaClickInterface,
    private val mContext: Context
) : RecyclerView.Adapter<InstantMediaRecyclerAdapter.MediaViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MediaViewHolder {
        val mBinding =
            RecyclerItemMediaBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class MediaViewHolder(private val mBinding: RecyclerItemMediaBinding) :
        ...
        fun bind(position: Int) {
            ...
            if (media.mMediaUri == null) {
                ...
                if (media.mMediaType == MEDIA_TYPE_VIDEO) mBinding.imageViewVideo.visibility =
                    View.VISIBLE
                ...
                itemView.setOnClickListener {
                    if (imageCount == 0) {
                        ...
                        mInterface.onMediaLongClick(
                            media,
                            this@InstantMediaRecyclerAdapter::class.java.simpleName
                        )
                    } else {
                        Toast.makeText(
                            mContext,
                            "Cannot add more than $maxCount items",
                            LENGTH_SHORT
                        ).show()
                    }
                }
